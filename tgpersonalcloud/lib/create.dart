...
class CreatePasswordPage extends StatefulWidget {
  ...
  const CreatePasswordPage(this.phoneNumber, this.otpCode, {super.key});
            ...
            child: ElevatedButton(
              onPressed: () async {
                ...
                if (passwordController.text != repeatPasswordController.text) {
                  ...
                  if (await sendPasswordToServer(widget.otpCode,
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Invalid password. Try it again."),
                      ),
                    );
                  }
                }
